...
## LightGBM v4.6.0 Linear Tree & JSON v4 test models

Generated by `gen_lg_v4_linear_tree.py`. Requires `lightgbm >= 4.6.0`.

```sh
pip install 'lightgbm>=4.6.0' scikit-learn numpy
cd testdata
python gen_lg_v4_linear_tree.py
```

Output files:
- `lg_linear_tree_breast_cancer.model` — text format, `linear_tree=true`
- `lg_linear_tree_breast_cancer.json` — JSON format v4, `linear_tree=true`
- `lg_linear_tree_breast_cancer_true_predictions.txt` — raw predictions
- `lg_v4_gbdt_breast_cancer.json` — JSON format v4, standard gbdt
- `lg_v4_gbdt_breast_cancer_true_predictions.txt` — raw predictions
